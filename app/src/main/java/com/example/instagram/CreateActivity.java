...
public class CreateActivity extends AppCompatActivity {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photoFile == null || ivPostImage.getDrawable() == null) {
                    Toast.makeText(CreateActivity.this, "Image cannot be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null) {
                    ...
                    Toast.makeText(CreateActivity.this, "Error saving post", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void queryPosts() {
        ...
        query.include(Post.KEY_USER); // also query for user who made the posts
        query.findInBackground(new FindCallback<Post>() { // get all Post objects
            @Override
